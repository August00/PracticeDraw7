    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 初始帧：progress 为 0
                Keyframe frame = Keyframe.ofFloat(0,0);
                // 时间进行到一般：progress 为 100
                Keyframe frame1 = Keyframe.ofFloat(0.5f,100);
                // 结束帧：progress 回落到 80
                Keyframe frame2 = Keyframe.ofFloat(1,80);
                // 使用 PropertyValuesHolder.ofKeyframe() 来把关键帧拼接成一个完整的属性动画方案
                PropertyValuesHolder holder = PropertyValuesHolder.ofKeyframe("progress",frame,frame1,frame2);
